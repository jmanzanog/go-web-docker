...
.PARAMETER Clean
Removes the image go-web-docker and kills all containers based on that image.
.PARAMETER Environment
The enviorment to build for (Debug or Release), defaults to Debug
.EXAMPLE
C:\PS> .\dockerTask.ps1 -Build
Build a Docker image named go-web-docker
#>
...
$imageName="go-web-docker"
$projectName="gowebdocker"
$publicPort=4500
