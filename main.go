...
func main() {
	...
	server.Handle("/items/", "GET", server.AddMiddleware(ItemHandler, CacheMiddleware(), LoggingMiddleware()))

	server.Handle("/health", "GET", server.AddMiddleware(HealthCheckerHandler, LoggingMiddleware()))
