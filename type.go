...
func (i *Item) SetCache() *Item {
	...
	sqlStatement := `
INSERT INTO item (id, title, category_id, price,start_time,stop_time)
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id`
	id := ""
	...
	log.Printf("New ITEM ID is:", id)
	if id != "" {
		sqlStatement = `
INSERT INTO child (id, parent_id, stop_time)
VALUES ($1, $2, $3)
RETURNING id`
...
SELECT * FROM item WHERE id = $1`
	...
	sqlStatement = `
SELECT c.id, c.stop_time FROM item i, child c WHERE i.id = $1 AND c.parent_id = $1`
...
type Health struct {
	...
	AvgResponseTime,
	TotalRequest,
	AvgResponseTimeApiCalls,
	TotalCountApiCall float64
